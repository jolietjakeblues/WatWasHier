...
import { actionForInteractiveClick, actionForMapClick, buildingIdFromFeature } from './map-interaction';
...
describe('map interaction', () => {
  ...
  it('laat een archeologieklik niet doorvallen naar gebouw of locatie', () => {
    expect(actionForInteractiveClick([{ properties: { resource: 'https://example.test/cho/1' } }], [{ id: 9, properties: { identificatie: 'BAG-123' } }], 6.1, 52.5))
      .toEqual({ type: 'select-archaeology', resource: 'https://example.test/cho/1' });
  });
});
