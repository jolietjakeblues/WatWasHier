<script lang="ts">
  ...
  import { archaeologyPopup, bagPopup, disappearedVillagePopup, minuutplanPopup, monumentNumber, municipalityHistoryPopup, perceelPopup, rcePopup, toponymPopup } from '$lib/feature-popup';
  ...
  $effect(() => { showBuildings; showHeritage; showFaces; showWorldHeritage; showArchaeology; showMunicipalityHistory; showMinuutplans; showToponyms; showPercelen; showDisappearedVillages; showHistorical; background; syncLayerVisibility(); updateMapUrl(); });
  $effect(() => {
